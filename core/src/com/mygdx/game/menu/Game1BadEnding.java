...
public class Game1BadEnding extends ScreenAdapter {


    private ScreenManager screenManager;
    private Texture instructions = new Texture(Gdx.files.internal("game1/game1badEnding.png"));

    public Game1BadEnding(ScreenManager screenManager) {
